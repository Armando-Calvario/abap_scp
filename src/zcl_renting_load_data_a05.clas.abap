CLASS zcl_renting_load_data_a05 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_renting_load_data_a05 IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.
    DATA:   lt_brands       TYPE TABLE OF   zrent_brands_a05,
            lt_cars         TYPE TABLE OF   zrent_cars_a05,
            lt_customers    TYPE TABLE OF   zrent_cusmrs_a05.
*    BRANDS
    lt_brands = VALUE #(
    ...
    INSERT zrent_brands_a05 FROM TABLE @lt_brands.
    SELECT * FROM zrent_brands_a05 INTO TABLE @lt_brands.
    out->write( sy-dbcnt ).
...
*    CARS
    lt_cars = VALUE #(
        ...
        ( matricula = '2837SUF' marca = 'MERCEDES'  modelo = 'CLASE C'          color = 'AMARILLO'  motor = '3.0' potencia = '220' und_potencia = 'CV' combustible = 'GASOLINA'
            consumo = '6.00'    fecha_fabr = '20200614' puertas = '5' precio = '180' moneda = 'USD' alquilado = 'X' alq_desde = '20241201' alq_hasta = '20231206' )
    ...
    DELETE FROM zrent_cars_a05.
    INSERT zrent_cars_a05 FROM TABLE @lt_cars.
    SELECT * FROM zrent_cars_a05 INTO TABLE @lt_cars.
    out->write( sy-dbcnt ).
...
*    CUSTOMERS
    ...
    DELETE FROM zrent_cusmrs_a05.
    INSERT zrent_cusmrs_a05 FROM TABLE @lt_customers.
    SELECT * FROM zrent_cusmrs_a05 INTO TABLE @lt_customers.
    out->write( sy-dbcnt ).
    out->write( 'zrent_cusmrs_a05 data inserted succesfully!' ).
  ENDMETHOD.
ENDCLASS.
